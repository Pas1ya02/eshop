                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <?php $Profile_image_rs = Database::search("SELECT * FROM images WHERE product_id='" . $selected_data['id'] . "'");
                                    $Profile_image_num = $Profile_image_rs->num_rows;
                                    $Profile_image_data = $Profile_image_rs->fetch_assoc(); 
                                    if($Profile_image_num != 0){
                                    ?>
                            <img src="<?php echo $Profile_image_data['code'];?>" style="height:200px;margin-left: auto;" />
                            <?php
                                    }else{
                                        ?>
                            ...
                            ?>
                                ...
                                <div class="col-12">
                                    ...
                                    <?php $name_rs= Database::search("SELECT * FROM user WHERE email = '".$selected_data["user_email"]."'");
                                    $name_num = $name_rs->num_rows;
                                    $name_data = $name_rs->fetch_assoc();
                                    ?>
                                    <span class="fs-5"><?php echo $name_data["fname"]; ?></span><br />
