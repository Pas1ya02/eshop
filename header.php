                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body overflow-scroll">
                                  ...
                                  <div class="col-12 mt-2">
                                            ...
                                            <div class="col-8 rounded bg-success">
                                                <div class="row">
                                                    <div class="col-12 pt-2">
                                                        ...
                                                        $c= Database::search("SELECT * FROM `chat1` where `from` = '".$a_data["email"]."'ORDER BY `date_time` DESC"); 
                                                        $cn = $c->num_rows;
                                    ...
                                    <div class="col-12 mt-2">
                                    <?php 
                                                        $e= Database::search("SELECT * FROM `chat2` where `to` = '".$a_data["email"]."'ORDER BY `date_time` DESC"); 
                                                        $en = $e->num_rows;
                                                  
                                                        $e_data = $e->fetch_assoc();
                                                        if ($e_data["status"] == 0) {
                                        ...
                                        <div class="row">
                                            <div class="offset-4 col-8 rounded bg-primary">
                                                <div class="row">
                                                    <div class="col-12 pt-2">
                                                        <span class="text-white fw-bold fs-4"><?php echo $e_data["content"];?></span>
                                                    </div>
                                                    <div class="col-12 text-end pb-2">
                                                        <span class="text-white fs-6"><?php echo $e_data["date_time"];?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
